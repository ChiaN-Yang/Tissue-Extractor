...
# Parameters
IMG_FORMATS = ["bmp", "jpg", "jpeg", "png", "tif", "tiff", "dng", "webp", "mpo", "svs"]
...
def read_svs(img_path, img_level=3):
    image = pyvips.Image.new_from_file(img_path, level=img_level)
